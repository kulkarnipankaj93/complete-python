...
# continue statement: it is used to skip the current iteration of the loop and control flow of program goes
#                     to next iteration
...
# else block is not executed if we use break statement in the loop
